...
public class ExSample extends AppCompatActivity {
    ...
    Button bt;
    TextView tv;
    CheckBox checkbox1,checkbox2,checkbox3,checkbox4,checkbox5,checkbox6,checkbox7,checkbox8,checkbox9,checkbox10,checkbox11,checkbox12,checkbox13,checkbox14,checkbox15
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkbox1 = (CheckBox) findViewById(R.id.checkBox1);//チェックボックス関連付け
    ...
    public void onActivityResult(int reqcode, int result, Intent it){
        if(reqcode == SEND_TO && result == RESULT_OK){
